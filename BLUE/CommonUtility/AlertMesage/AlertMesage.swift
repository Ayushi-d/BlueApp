...
class AlertMesage: NSObject {
    public class func show(_ theme: Theme, title: String? = nil, message: String?) {
        ...
        view.configureContent(title: "Info", body: message, iconImage: nil, iconText: nil, buttonImage: nil, buttonTitle: "", buttonTapHandler: {  _ in SwiftMessages.hide() })
        ...
        switch theme {
        case .info:
            view.configureTheme(backgroundColor: UIColor.Color.buttonColor, foregroundColor: .white, iconImage: iconStyle.image(theme: .info), iconText: nil)
...
//            view.titleLabel?.text = "Success"
            ...
            view.iconImageView?.tintColor = UIColor.Color.green
            view.titleLabel?.text = "Success"
        ...
        case .warning:
            ...
            view.configureTheme(backgroundColor: UIColor.Color.buttonColor, foregroundColor: .white, iconImage: iconStyle.image(theme: .warning), iconText: nil)
            view.iconImageView?.image = view.iconImageView?.image!.withRenderingMode(.alwaysTemplate)
            view.iconImageView?.tintColor = UIColor.Color.buttonColor
        ...
        // Set Font
        view.titleLabel?.font = UIFont.sourceSansProRegular(size: 16)
        view.bodyLabel?.font = UIFont.sourceSansProRegular(size: 14)
        //
        // Set Shadow
